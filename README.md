...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-inventory-api?sort=semver)](https://github.com/liberusoftware/module-maintenance-inventory-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-inventory-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-inventory-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-inventory-api
```
...
<a href="https://github.com/liberusoftware/module-maintenance-inventory-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-inventory-api" alt="Contributors to liberusoftware/module-maintenance-inventory-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-inventory-api/graphs/contributors).
